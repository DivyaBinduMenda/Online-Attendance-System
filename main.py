...
############################################# FUNCTIONS ##########################
#To check wheter the files are in appropriate locations in the DOM
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'your_mail@gmail.com' ")

###################################################################################
#Checking for the Facial Recogniton model file
...
##################################################################################
#Main Password Change Interface
def change_pass():
    global master
    master = tk.Tk()
...
##################################################################################
#Clearing the input area --for ID
def clear():
    txt.delete(0, 'end')
    res = "1)Take Images  >>>  2)Save Profile"
    message1.configure(text=res)

#Clearing the input area --for Name
def clear2():
    txt2.delete(0, 'end')
    res = "1)Take Images  >>>  2)Save Profile"
    message1.configure(text=res)
...
##################################################################################
#For taking images as input and storing them
def TakeImages():
...
##################################################################################
#TRAINGING THE MODEL OVER NEW IMAGES
def TrainImages():
    check_haarcascadefile()
    assure_path_exists("TrainingImageLabel/")
    #recognizer = cv2.face.LBPHFaceRecognizer_create()
    #recognizer = cv2.face.LBPHFaceRecognizer_create() if cv2.__version__.startswith('3') else cv2.createLBPHFaceRecognizer()
    recognizer = cv2.createLBPHFaceRecognizer() if cv2.__version__.startswith('3') else cv2.face.LBPHFaceRecognizer_create()
